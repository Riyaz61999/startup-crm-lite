...
const QuickActions = ({ onAddLead, onViewAll, onExport }) => {
  return (
    <div className="bg-card border border-slate-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-between h-full">
      <div>
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={onAddLead}
            className="w-full flex items-center justify-between px-4 py-3 bg-primary text-white rounded-xl font-semibold text-sm shadow-sm hover:bg-primary/90 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer group"
          >
          ...
          <button
            onClick={onViewAll}
            className="w-full flex items-center justify-between px-4 py-3 bg-white text-text-dark border border-slate-200 rounded-xl font-semibold text-sm hover:bg-slate-50 hover:border-slate-300 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer group"
          >
            <div className="flex items-center gap-2.5">
              <Users className="w-4.5 h-4.5 text-text-gray group-hover:text-primary transition-colors duration-150" />
              <span>View All Leads</span>
            </div>
            <span className="text-[10px] bg-slate-100 text-text-gray group-hover:bg-primary/10 group-hover:text-primary px-2 py-0.5 rounded-md font-bold transition-colors duration-150">
              Browse
            </span>
          </button>
          ...
          <button
            onClick={onExport}
            className="w-full flex items-center justify-between px-4 py-3 bg-white text-text-dark border border-slate-250 border-dashed rounded-xl font-semibold text-sm hover:bg-slate-50 hover:border-slate-400 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer group"
          >
            <div className="flex items-center gap-2.5">
      ...
      <div className="mt-6 p-3.5 bg-slate-50/80 rounded-xl border border-slate-100/50">
